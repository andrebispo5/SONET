...
public abstract class Organization_Base extends pt.ist.sonet.domain.Agent {
    ...
    protected static class DO_State extends pt.ist.sonet.domain.Agent.DO_State {
        ...
        protected static class SerializedForm extends pt.ist.sonet.domain.Agent.DO_State.SerializedForm {
